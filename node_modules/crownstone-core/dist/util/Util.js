...
exports.Util = {
    ...
    crownstoneTimeToTimestamp: function (csTimestamp) {
        let now = Date.now();
    ...
    timestampToCrownstoneTime: function (utcTimestamp) {
    ...
    nowToCrownstoneTime: function () {
        return exports.Util.timestampToCrownstoneTime(Date.now());
    },
    versions: {
