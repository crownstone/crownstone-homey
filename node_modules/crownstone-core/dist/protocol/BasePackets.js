...
class FactoryResetPacket extends ControlPacket {
    constructor() {
        super(CrownstoneTypes_1.ControlType.FACTORY_RESET);
        this.loadUInt32(0xdeadbeef);
    }
}
exports.FactoryResetPacket = FactoryResetPacket;
class ControlStateGetPacket extends BasePacket {
    constructor(stateType, id, persistenceMode) {
        super(CrownstoneTypes_1.ControlType.GET_STATE);
        this.id = 0;
        this.persistenceMode = enums_1.GetPesistenceMode.CURRENT;
...
class ControlStateSetPacket extends BasePacket {
    constructor(stateType, id, persistenceMode) {
        super(CrownstoneTypes_1.ControlType.SET_STATE);
        this.id = 0;
        this.persistenceMode = enums_1.SetPesistenceMode.STORED;
        this.stateType = stateType;
        this.id = id;
        this.persistenceMode = persistenceMode;
    }
...
exports.ControlStateSetPacket = ControlStateSetPacket;
